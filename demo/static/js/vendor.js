/*! cf-tabs 2014-04-10 12:16:33 PM */
(function(global, factory) {
    ...
    var support = {};
    var version = "1.11.1-beta1", jQuery = function(selector, context) {
    ...
    function defaultPrefilter(elem, props, opts) {
        ...
        if (elem.nodeType === 1 && ("height" in props || "width" in props)) {
            ...
            if ((display === "none" ? defaultDisplay(elem.nodeName) : display) === "inline" && jQuery.css(elem, "float") === "none") {
